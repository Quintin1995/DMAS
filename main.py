...
for iteration in range(ITERATIONS):
    ...
    if PROTOCOL == Protocols.ANY:
        caller, receiver = protocols.choose_callers_any(AMOUNT_AGENTS)
...
for target_idx in range (AMOUNT_AGENTS):
    for agent_idx in range (AMOUNT_AGENTS):
        print ("Agent {} thinks agent {} has secret #{}".format(agent_idx, target_idx, get_secret_value(agent_idx, target_idx)))
